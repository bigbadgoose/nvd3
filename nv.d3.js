  ...
  */
  window.nv.models.tooltip = function() {
        ...
        */
        ...
        ,   snapDistance = 40   //Tolerance allowed before tooltip is moved from its current position (creates 'snapping' effect)
...
nv.models.flLineChart = function() {
  ...
  chart.showX2Axis = function(_) {
    if (!arguments.length) return showX2Axis;
    showX2Axis = _;
    return chart;
  };
